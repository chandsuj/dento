...
//        table.setPreferredSize(new Dimension(1800,1800));
    ...
    public static void masterSearch (String date, String firstName, String lastName, String phone )  throws Exception{
        String sql="select * from customer where "
                + "date = '" +date+"' OR "
                + "((firstn like '"+firstName+"' and lastn like '"+lastName+"') or"
                + " contno = '"+phone+"')";
